...
public class Funcoes implements Cloneable{
    ...
    void add_empregado()
    {
        ...
        while(true)
        {
            ...
            else
            {
                ...
                if(chave == 1)
                {
                    add_horista(sindicate, is_sindicate, taxa_mensal_sindicato, name, endereco, salario);
                    break;
                }
                else
                {
                    add_assalariado(sindicate, is_sindicate, taxa_mensal_sindicato, name, endereco, salario);
                    break;
                }
            }
        }
    ...
    void add_horista(int sindicate, boolean is_sindicate, double taxa_mensal_sindicato, String name, String endereco, double salario_hora)
    {
        String metodo_pag;
    ...
    void add_assalariado(int sindicate, boolean is_sindicate, double taxa_mensal_sindicato, String name, String endereco, double salario_assalariado)
    {
        String metodo_pag;
        int comissionado;
        double comissao = -1;
